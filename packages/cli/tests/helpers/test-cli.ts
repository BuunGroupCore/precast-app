...
export class CLITestRunner {
  ...
  async generateProject(
    ...
    const args = [
      ...
      combination.docker ? "--docker" : "",
      combination.includeRedis ? "--include-redis" : "",
      combination.includeAdminTools ? "--include-admin-tools" : "",
      combination.autoDeploy ? "--auto-deploy" : "",
      combination.securePasswords === false ? "--no-secure-passwords" : "",
      "--no-git",
