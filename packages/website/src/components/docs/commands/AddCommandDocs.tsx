...
export function AddCommandDocs() {
  ...
  return (
    <section className="comic-panel p-6">
      <h2 id="add-overview" className="font-comic text-3xl text-comic-green mb-6">
        add Command
      </h2>
      ...
      <div id="add-resources" className="mb-6">
        <h3 className="font-comic text-xl mb-3">Available Resources</h3>
      ...
      <div id="add-examples" className="mt-6">
        ...
        <div className="mt-6 bg-comic-yellow/20 p-4 rounded-lg border-2 border-comic-black">
          <h4 className="font-comic text-lg mb-2">Component Generation Features</h4>
