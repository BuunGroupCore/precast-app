...
export class DataProcessorService {
  ...
  private getRawEvents(events: PostHogEventResponse): RawEventData[] {
    ...
    return events.results.map(event => ({
      ...
      cli_version: event.properties?.cli_version as string | undefined,
      cli_version_major: event.properties?.cli_version_major as string | undefined,
      platform: event.properties?.platform as string | undefined,
      platform_display: event.properties?.platform_display as string | undefined,
      platform_arch: event.properties?.platform_arch as string | undefined,
      platform_type: event.properties?.platform_type as string | undefined,
      platform_release: event.properties?.platform_release as string | undefined,
      node_version: event.properties?.node_version as string | undefined,
      node_version_major: event.properties?.node_version_major as string | undefined,
      framework: event.properties?.framework as string | undefined,
      backend: event.properties?.backend as string | undefined,
      database: event.properties?.database as string | undefined,
      orm: event.properties?.orm as string | undefined,
      styling: event.properties?.styling as string | undefined,
      packageManager: event.properties?.packageManager as string | undefined,
