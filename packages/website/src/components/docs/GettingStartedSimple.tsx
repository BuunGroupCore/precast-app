  ...
  return (
    <div className="space-y-8">
      <section id="installation" className="comic-panel p-6">
        <h2 className="font-comic text-3xl text-comic-blue mb-6">Installation</h2>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            <h3 className="font-comic text-lg">Alternative Package Managers</h3>
            <CodeBlock
              code={`# Yarn
...
bun create precast-app`}
      ...
      <section id="project-setup" className="comic-panel p-6">
        <h2 className="font-comic text-3xl text-comic-green mb-6">Project Setup</h2>

        <div className="space-y-6">
          <div>
            <h3 className="font-comic text-lg mb-3">1. Navigate to your project</h3>
            <CodeBlock code="cd my-app" />
          </div>

          <div>
            <h3 className="font-comic text-lg mb-3">
          ...
          <div>
            <h3 className="font-comic text-lg mb-3">3. Start the development server</h3>
      ...
      <section id="next-steps" className="comic-panel p-6">
        <h2 className="font-comic text-3xl text-comic-purple mb-6">Next Steps</h2>
