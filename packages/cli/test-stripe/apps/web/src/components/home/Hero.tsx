...
export function Hero() {
  ...
  const techStack = [
    ...
    { name: "EXPRESS", icon: <SiExpress size={20} />, color: "text-black" },
    { name: "POSTGRES", icon: <SiPostgresql size={20} />, color: "text-black" },
    { name: "PRISMA", icon: <SiPrisma size={20} />, color: "text-black" },
  ];
  ...
  return (
    <div className="hero-section">
      ...
      <div className="terminal-window">
        ...
        <div className="terminal-content">
          ...
          <div className="system-status">
            ...
            <div className="status-line">
              <span className="status-ok">[OK]</span>
              <span className="status-text">Connecting to express API...</span>
      ...
      <div className="project-title">
        <h1 className="hero-title">{APP_CONFIG.displayName.toUpperCase()}</h1>
      </div>
