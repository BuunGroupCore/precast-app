...
export type SpacingScale = keyof SpacingTokens;
export type BorderRadiusScale = keyof BorderRadiusTokens;
export type BorderWidthScale = keyof BorderWidthTokens;
