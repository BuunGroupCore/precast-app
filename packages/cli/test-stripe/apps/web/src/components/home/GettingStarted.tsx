...
import { Terminal, Play, Database, Globe, Package } from "lucide-react";
...
export function GettingStarted() {
  ...
  const commands = {
    development: [
      ...
      { cmd: "bun run db:studio", desc: "Open Prisma Studio", icon: <Globe size={14} /> },
    ],
    production: [
            ...
            <div className="pro-tip">
              <div className="tip-content">
                ...
                <p className="tip-text">
                  Use <code className="inline-code">bun run dev</code> to start the development
                  server
                </p>
              </div>
            </div>
