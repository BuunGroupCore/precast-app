...
export async function generateNoneTemplate(
  ...
  /** Create directory structure for backend-only project */
...
function main(): void {
  ...
  console.log('Your backend-only project is ready.');
...
Backend-only project generated by create-precast-app.
...
This is a minimal backend-only setup. Consider adding:
