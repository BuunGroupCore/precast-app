...
export const CSS_CLASSES = {
  ...
  TAILWIND: {
    ...
    BUTTON_SECONDARY:
      "w-full px-4 py-3 bg-white border-2 border-black text-black font-bold uppercase text-sm tracking-wider shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[2px] hover:translate-y-[2px] transition-all duration-150 disabled:opacity-50 disabled:cursor-not-allowed",
    INPUT_FIELD: "w-full px-3 py-2 border-2 border-black text-sm font-mono",
    CARD: "border-2 border-black p-4 bg-white",
    FLOATING_BUTTON:
      "fixed bottom-6 right-6 z-50 bg-yellow-400 border-2 border-black p-3 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[2px] hover:translate-y-[2px] transition-all duration-150 group",
    PANEL:
      "bg-white border-2 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] transition-all duration-200",
  },
